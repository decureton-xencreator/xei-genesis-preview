const XFS_RELEASE=Object.freeze({studio:'XFS',version:'1.1.0',xenCentric:true,institutionalMemory:true,proofLinks:true,manualReturn:true,contentPlane:true,commercialReview:true,controllerOwner:'src/ed-premiere-clean-v1.js',finaleNarrationOwner:'branch-controller'});window.XFS_RELEASE=XFS_RELEASE;document.documentElement.dataset.xfs='1.1.0';
