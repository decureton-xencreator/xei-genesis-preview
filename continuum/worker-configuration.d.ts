/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=continuum/wrangler.jsonc continuum/worker-configuration.d.ts` (hash: 02ad1eae5d4086b1c7591c7175637476)
// Runtime types generated with workerd@1.20260714.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	CONTINUUM_ARTIFACTS: R2Bucket;
	CONTINUUM_DB: D1Database;
	CONTINUUM_QUEUE: Queue;
	XEN_RUNTIME_MODE: "staging" | "local-reconstruction";
	XEN_AUTH_MODE: "cloudflare-access" | "local-headers";
	XEN_ACCESS_TEAM_DOMAIN?: "https://cool-silence-82b1.cloudflareaccess.com";
	XEN_ACCESS_AUD?: "c007ebf6201f421334e7234f20eea96dfbf6106e1b985c28cc9bf1f1684b0d02";
	XEN_ACCESS_ADMIN_EMAIL_SHA256?: "8bc36a88c3de70a77d268157d44a980966d977e894fdfe7d14ad094e5af25206";
	XEN_MODEL_EXECUTION?: "enabled";
	XEN_SAFE_MODE: "false" | "true";
	XEN_EMERGENCY_STOP: "false";
	ANTHROPIC_MODEL?: "claude-sonnet-5";
	ANTHROPIC_MAX_CONCURRENCY?: "1";
	ANTHROPIC_DAILY_BUDGET_USD?: "5.00";
	ANTHROPIC_MONTHLY_BUDGET_USD?: "50.00";
	ANTHROPIC_MISSION_BUDGET_USD?: "0.10";
	CONTINUUM_MISSION: DurableObjectNamespace<import("./src/index").MissionCoordinator>;
	CONTINUUM_WORKFLOW: Workflow<Parameters<import("./src/index").MissionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MissionCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "XEN_RUNTIME_MODE" | "XEN_AUTH_MODE" | "XEN_ACCESS_TEAM_DOMAIN" | "XEN_ACCESS_AUD" | "XEN_ACCESS_ADMIN_EMAIL_SHA256" | "XEN_MODEL_EXECUTION" | "XEN_SAFE_MODE" | "XEN_EMERGENCY_STOP" | "ANTHROPIC_MODEL" | "ANTHROPIC_MAX_CONCURRENCY" | "ANTHROPIC_DAILY_BUDGET_USD" | "ANTHROPIC_MONTHLY_BUDGET_USD" | "ANTHROPIC_MISSION_BUDGET_USD">> {}
}
