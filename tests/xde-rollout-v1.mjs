...
for(const term of ["version:'2.2.0-finish'","rolloutStyle.href='src/xde-rollout-v1.css'","start.addEventListener('click',begin)","selectedMandate.textContent","event.key==='Escape'","start.focus({preventScroll:true})","requestAnimationFrame"]){
...
for(const forbidden of ['phone-gold-runtime','app-v6.js','speechSynthesis'])if(html.includes(forbidden)||js.includes(forbidden))throw new Error(`Deprecated rollout dependency detected: ${forbidden}`);
