...
for(const asset of ['executive-arrival-v1.js?v=5ed-exact-1','executive-arrival-v1.css?v=5ed-exact-1','ed-premiere-clean-v1.js?v=scroll-target-5','ed-premiere-clean-v1.css','xfs-xen-centric-finish-v1.js?v=solutions-gateway-2','xfs-xen-centric-finish-v1.css?v=commercial-rollout-1','xen-conversation-mode-v1.js?v=glitch-entry-7','xen-conversation-mode-v1.css?v=ab0d-canonical-1'])if(!html.includes(asset))throw new Error(`Active finish asset missing: ${asset}`);
